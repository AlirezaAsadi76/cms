                        ...
                        <form action="{{ route('pages.update',['page'=>$page->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group" @if ($errors->has('thumbnail')) has-error @endif>
                                ...
                                <input type="text" name="thumbnail" id="thumbnail" class="form-control"
                                  value="{{ $page->thumbnail }}"  placeholder="Thumbnail">
                            ...
                            <div class="form-group" @if ($errors->has('sub_title')) has-error @endif>
                                ...
                                value="{{ $page->sub_title }}" placeholder="sub_title">
                            ...
                            <div class="form-group" @if ($errors->has('details')) has-error @endif>
                                ...
                                <textarea name="details" id="details" class="form-control"  placeholder="Details">{{$page->details}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select name="publish" id="publish" class="form-control">
                                    <option value=1 @if ($page->is_published==1)
                                        selected='selected'
                                    @endif >Publish</option>
                                    <option value=0 @if ($page->is_published==0)
                                        selected='selected'
                                    @endif>Draft</option>
                                </select>
                            </div>
